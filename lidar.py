...
def findexactvanes(lower_angle_L, lower_angle_R, upper_angle_L, upper_angle_R, lower_distance_L, lower_distance_R,
    ...
    for y in range(0, 20):
        ...
        for i, scan in enumerate(mylidar.iter_scans(scan_type='normal', max_buf_meas=60000)): #scan_type='normal', max_buf_meas=60000
...
def findvanes():
    ...
    if firstvane[1]<secondvane[1]:
        arr_mean_L, arr_mean_R, arr_avg_angle_L, arr_avg_angle_R = findexactvanes(firstvane[1] - 3, secondvane[1] - 3,
                                                                                  firstvane[1] + 3, secondvane[1] + 3,
                                                                                  firstvane[2] - 10, secondvane[2] - 10,
                                                                                  firstvane[2] + 20, secondvane[2] + 20)
    else:
        arr_mean_L, arr_mean_R, arr_avg_angle_L, arr_avg_angle_R = findexactvanes(secondvane[1] - 3, firstvane[1] - 3,
                                                                                  secondvane[1] + 3, firstvane[1] + 3,
                                                                                  secondvane[2] - 10, firstvane[2] - 10,
                                                                                  secondvane[2] + 20, firstvane[2] + 20)
