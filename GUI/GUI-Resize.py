...
class MyApp:
    def __init__(self, parent):
        ...
        self.rx_label.configure(font=("Arial", 12, "bold"), bg='#00A1E4')
        ...
        self.ry_label.configure(font=("Arial", 12, "bold"), bg='#00A1E4')
        ...
        self.rz_label.configure(font=("Arial", 12, "bold"), bg='#00A1E4')
